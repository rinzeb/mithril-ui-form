...
You can also include _markdown_ in your UIForm.`,
  ...
  { id: "timeOfBirth", type: "datetime", label: "Time of birth?", className: 'col s6 m3' },
  { id: 'created', label: 'Created "{{event}}" event on:', type: 'date', required: true },
  { id: 'start', type: 'time', required: true },
...
export const FormView = () => {
  ...
  state.result = {
    ...
    start: new Date('2019-12-01T09:05:00.000Z'),
    created: new Date('2021-03-01T22:00:00.000Z'),
    edited: new Date('2021-03-08T22:00:00.000Z'),
    timeOfBirth: new Date('2000-03-08T08:45:00.000Z'),
    categories: ['test', 'me'],
    event: 'Test me event',
